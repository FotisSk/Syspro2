...
void showactive_coord(int readfd, int writefd, char *buffer, poolInfo *coordStorageArray, int nextAvailablePos, int numOfPools)
{
	int status, i, j, k, l;
	...
	sprintf(messageToConsole, "Active jobs:");
