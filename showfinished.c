...
void showfinished_coord(int readfd, int writefd, char *buffer, poolInfo *coordStorageArray, int nextAvailablePos, int numOfPools)
{
	...
	sprintf(messageToConsole, "Finished jobs:");
